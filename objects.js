...
console.log("Hoi! Ik ben " + information.fullName + " en ik ben " + information.age + " jaar oud");
...
const product = {
  ...
  discription: "De Smeg Waterkoker is gemaakt van roestvrijstaal en kunststof",
};
